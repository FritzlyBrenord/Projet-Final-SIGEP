...
// Professeurs par défaut (tableau temporaire)
const DEFAULT_PROFESSEURS: Professeur[] = [
  {
    id: "1",
    ...
    nom: "Dupont",
    prenom: "Marie",
    email: "marie.dupont@imfp.edu.ht",
    ...
    sequences: [
      {
        id: "seq1",
        classe: "1ère Année Fondamentale",
        salle: "Salle A1",
        matiere: "Français",
      },
      {
        id: "seq2",
        classe: "2e Année Fondamentale",
        salle: "Salle A2",
        matiere: "Français",
      },
    ],
    diplomes: "Licence en Lettres",
    statut: "actif",
  ...
  },
  {
    ...
    sequences: [
      ...
      {
        id: "seq4",
        classe: "3e Année Fondamentale",
        salle: "Salle B2",
        matiere: "Mathématiques",
      },
    ],
    diplomes: "Master en Mathématiques",
    statut: "actif",
    annee_scolaire_id: "2024-2025",
    created_at: "2024-08-15T08:00:00Z",
    updated_at: "2024-08-15T08:00:00Z",
  ...
  {
    id: "3",
    enseignant_id: "ENS003",
    code: "PROF003",
    nom: "Leblanc",
    prenom: "Sophie",
    email: "sophie.leblanc@imfp.edu.ht",
    ...
    sequences: [
      {
        id: "seq5",
        classe: "4e Année Fondamentale",
        salle: "Salle C1",
        matiere: "Sciences",
      },
      {
        id: "seq6",
        classe: "5e Année Fondamentale",
        salle: "Salle C2",
        matiere: "Biologie",
      },
    ],
    diplomes: "Licence en Biologie",
    statut: "actif",
    annee_scolaire_id: "2024-2025",
    created_at: "2024-08-15T08:00:00Z",
    updated_at: "2024-08-15T08:00:00Z",
